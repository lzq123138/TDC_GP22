...
#define OLED_SCLK_Clr() GPIO_ResetBits(GPIOB,GPIO_Pin_13)//D0
#define OLED_SCLK_Set() GPIO_SetBits(GPIOB,GPIO_Pin_13)

#define OLED_SDIN_Clr() GPIO_ResetBits(GPIOB,GPIO_Pin_15)//D1
...
#define OLED_CS_Clr()  GPIO_ResetBits(GPIOC,GPIO_Pin_6)//CS
#define OLED_CS_Set()  GPIO_SetBits(GPIOC,GPIO_Pin_6)
...
void OLED_ShowString(u8 x,u8 y,const u8 *chr,u8 size1);
